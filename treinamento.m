function varargout = treinamento(varargin)

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @treinamento_OpeningFcn, ...
                   'gui_OutputFcn',  @treinamento_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before treinamento is made visible.
function treinamento_OpeningFcn(hObject, eventdata, handles, varargin)
...
responseFile = fopen(strcat(dir,'/','trainning.csv'), 'w');
handles.responseFile = responseFile;
fprintf(responseFile, '#,question,right_answer,given_answer,hits,time\n');
...
function varargout = treinamento_OutputFcn(hObject, eventdata, handles) 
